...
const AttendancePage: React.FC = () => {
  ...
  const fetchAttendanceData = async () => {
    ...
    try {
      setIsLoading(true);
      const response = await axios.get<ApiResponse<AttendanceRecord[]>>('https://dev.thynkcorp.com/backend/api/Attendances', {
        params: {
  ...
  const calculateStats = () => {
    if (!attendanceData.length) return { present: 0, absent: 0, leave: 0, weekend: 0 };
    ...
    return { present, absent, leave, weekend };
  };

  const stats = calculateStats();

  const getPercentage = (value: number) => {
    const total = stats.present + stats.absent + stats.leave + stats.weekend;
          ...
          <CardContent className="p-4 md:p-6">
            <div className="grid grid-cols-2 gap-4 md:grid-cols-2 lg:grid-cols-4 md:gap-6">
              <div className="flex items-center justify-between md:block">
                <div className="h-1 bg-green-500 absolute top-0 left-0 w-full md:static md:rounded-t-lg"></div>
              ...
              <div className="flex items-center justify-between md:block">
                <div className="h-1 bg-red-500 absolute top-0 left-0 w-full md:static md:rounded-t-lg"></div>
                <div className="flex items-center md:block pt-2 md:pt-4">
              ...
              <div className="flex items-center justify-between md:block">
                <div className="h-1 bg-amber-500 absolute top-0 left-0 w-full md:static md:rounded-t-lg"></div>
                <div className="flex items-center md:block pt-2 md:pt-4">
              ...
              <div className="flex items-center justify-between md:block">
                <div className="h-1 bg-blue-500 absolute top-0 left-0 w-full md:static md:rounded-t-lg"></div>
                <div className="flex items-center md:block pt-2 md:pt-4">
